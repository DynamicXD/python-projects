...
close_button = Button(title_bar, text='  ×  ', command=root.destroy, bg=gray15, padx=2, pady=2, font=("calibri", 13),
                      bd=0, fg='white', highlightthickness=0)
expand_button = Button(title_bar, text=' 🗖 ', bg=gray15, padx=2, pady=2, bd=0, fg="#757575", font=("calibri", 13),
                       highlightthickness=0)
minimize_button = Button(title_bar, text=' 🗕 ', command=minimize_me, bg=gray15, padx=2, pady=2, bd=0, fg='white',
                         font=("calibri", 13), highlightthickness=0)
title_bar_title = Label(title_bar, text=tk_title, bg=gray15, bd=0, fg='white', font=("helvetica", 10),
                        highlightthickness=0)
...
MainPageTitleLabel = Label(MainPageFrame, text=MainPageTitleText, font=("Arial", 25), bg=gray25, fg="white",
                           wraplength=rootWidth - 25, justify="center")  # Page title
MainPageTitleLabel.pack()

MainPageSubTitleLabel = Label(MainPageFrame, text=MainPageSubTitleText, font=("Arial", 12), bg=gray25, fg="white",
                              wraplength=rootWidth - 25, justify="center")  # Page sub title
MainPageSubTitleLabel.pack()

MainSettingsLabel = Label(MainPageFrame, text="Settings", font=("Arial", 22), bg=gray25, fg="white",
                          wraplength=rootWidth - 25)  # Settings text
...
for x in range(0, 3):  # Creates 3 settings buttons
    # Button
    settingsButton = Button(MainSettingsFrame, width=10, text=settingsButtonsText[x], font=("Arial", 14, "bold"),
                            bg=gray20, activebackground=gray10, fg="white", activeforeground="white", borderwidth=1)
    ...
    # Label
    settingsLabel = Label(MainSettingsFrame, bg=gray25, text=settingsLabelsText[x], font=("Arial", 12), fg="white",
...
commandsLabel = Label(CommandSettingsFrame, text=commandsTitleText, font=("Arial", 25), bg=gray25, fg="#fff",
                      wraplength=rootWidth - 25, justify="center")  # Title Label
commandsLabel.pack()

commandsSubLabel = Label(CommandSettingsFrame, text=commandsTitleSubText, font=("Arial", 14), bg=gray25, fg="#fff",
                         wraplength=rootWidth - 25, justify="center")  # Sub Title Label
...
for x in range(7):  # Creates all the command buttons, text labels, and requirements
    ...
    # Text label for the button
    CommandLabel = Label(buttonsFrame, bg=gray25, text="- pls " + CommandButtonLabelText[x], font=("Arial", 18),
                         fg="white")
...
saveButton = Button(CommandSaveExitFrame, width=10, textvariable=saveButtonText, font=("Arial", 18, "bold"),
                    bg=saveButtonColor, activebackground=greenActiveColor, fg="white", activeforeground="white",
...
## Exit Button ##
exitButton = Button(CommandSaveExitFrame, width=10, text="Cancel", font=("Arial", 18, "bold"), bg=exitButtonColor,
                    activebackground=redActiveColor, fg="white", activeforeground="white", command=ExitCommandSettings)
...
powerupTitleLabel = Label(PowerupSettingsFrame, text=powerupTitleText, font=("Arial", 25), bg=gray25, fg="#fff",
                          wraplength=rootWidth - 25, justify="center")  # Title Label
powerupTitleLabel.pack()

powerupSubTitleLabel = Label(PowerupSettingsFrame, text=powerupSubTitleText, font=("Arial", 14), bg=gray25, fg="#fff",
                             wraplength=rootWidth - 25, justify="center")  # Sub Title Label
...
for x in range(4):  # Creates all the command buttons, text labels, and amount buttons.
    ...
    lowerAmountButton = Button(powerupButtonsFrame, width=2, height=1, text="-", font=("Arial", 12, "bold"), bg=gray20,
                               activebackground=gray10, fg="white", activeforeground="white")
    ...
    amountLabel = Label(powerupButtonsFrame, bg=gray25, textvariable=amountText, font=("Arial", 15, "bold"), fg="white",
                        width=2, height=1)
    amountLabel.grid(row=x, column=4, sticky="NW")

    upAmountButton = Button(powerupButtonsFrame, width=2, height=1, text="+", font=("Arial", 12, "bold"), bg=gray20,
                            activebackground=gray10, fg="white", activeforeground="white")
...
powerupsSaveButton = Button(powerupSaveExitFrame, width=10, textvariable=powerupsSaveButtonText,
                            font=("Arial", 18, "bold"), bg=saveButtonColor, activebackground=greenActiveColor,
                            fg="white", activeforeground="white", command=SavePowerups)
...
powerupsExitButton = Button(powerupSaveExitFrame, width=10, text="Cancel", font=("Arial", 18, "bold"),
                            bg=exitButtonColor, activebackground=redActiveColor, fg="white", activeforeground="white",
                            command=ExitPowerupSettings)
...
PositionsTitleLabel = Label(PositionsFrame, text=PositionsTitleText, font=("Arial", 25), bg=gray25, fg="#fff",
                            wraplength=rootWidth - 25, justify="center")
PositionsTitleLabel.pack()

PositionsSubTitleLabel = Label(PositionsFrame, text=PositionsSubTitleText, font=("Arial", 12), bg=gray25, fg="#fff",
                               wraplength=rootWidth - 25, justify="center")
PositionsSubTitleLabel.pack()

instructionsText = StringVar()
instructionsLabel = Label(PositionsFrame, textvariable=instructionsText, font=("Arial", 15), background=gray25,
                          fg="white", wraplength=rootWidth - 25, justify=CENTER)
...
for x in range(0, 2):
    # Button
    positionsButton = Button(positionButtonsFrame, text=PositionButtonsText[x], font=("Arial", 15), bg=gray20,
                             activebackground=gray10, fg='white', activeforeground='white', width=15)
    ...
    positionsLabel = Label(positionButtonsFrame, bg=gray25, textvariable=positionsText, font=("Arial", 13, "bold"),
                           fg="white")
...
positionsSaveButton = Button(positionsSaveExitFrame, width=10, text="Save", font=("Arial", 18, "bold"),
                             bg=saveButtonColor, activebackground=greenActiveColor, fg="white",
                             activeforeground="white", command=SavePositions)
...
positionsExitButton = Button(positionsSaveExitFrame, width=10, text="Cancel", font=("Arial", 18, "bold"),
                             bg=exitButtonColor, activebackground=redActiveColor, fg="white", activeforeground="white",
                             command=ExitPositionsSettings)
...
RunPageTitleLabel = Label(RunPageFrame, text=RunPageTitleText, font=("Arial", 25), bg=gray25, fg="white",
                          wraplength=rootWidth - 25, justify="center")  # Page title
RunPageTitleLabel.pack()

RunPageSubTitleLabel = Label(RunPageFrame, text=RunPageSubTitleText, font=("Arial", 12), bg=gray25, fg="white",
                             wraplength=rootWidth - 25, justify="center")  # Page sub title
...
RunTimeLabel = Label(RunPageFrame, textvariable=RunTimeText, font=("Arial", 15), bg=gray25, fg="white",
                     wraplength=rootWidth - 25)  # Settings text
...
RunCommandsLabel = Label(RunPageFrame, textvariable=RunCommandsText, font=("Arial", 15), bg=gray25, fg="white",
                         wraplength=rootWidth - 25)  # Settings text
...
RunCurrencyCommandsLabel = Label(RunPageFrame, textvariable=RunCurrencyCommandsText, font=("Arial", 15), bg=gray25,
                                 fg="white", wraplength=rootWidth - 25)  # Settings text
...
RunSafetyCommandsLabel = Label(RunPageFrame, textvariable=RunSafetyCommandsText, font=("Arial", 15), bg=gray25,
                               fg="white", wraplength=rootWidth - 25)  # Settings text
...
RunPowerupCommandsLabel = Label(RunPageFrame, textvariable=RunPowerupCommandsText, font=("Arial", 15), bg=gray25,
                                fg="white", wraplength=rootWidth - 25)  # Settings text
...
runBotButton = Button(MainPageFrame, width=10, text="Run Bot", font=("Arial", 18, "bold"), bg=saveButtonColor,
                      activebackground=greenActiveColor, fg="white", activeforeground="white",
                      command=runBotButtonClicked)
